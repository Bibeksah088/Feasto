    ...
    <div style={{ backgroundImage: `url(${assets.headerBI})`}} className='h-[38vw] bg-cover bg-center p-[1.5rem] m-[25px] auto rounded-md '>
       <div className='p-[2.2rem] flex flex-col gap-[4rem] pt-[7%] animate-fadein'>
        ...
        <p className="hidden xl:block text-white max-w-full sm:max-w-[650px] text-[18px]">
          Feasto brings your favorite meals right to your doorstep with just a few clicks. Enjoy a wide selection of restaurants and dishes, all tailored to your taste. With fast, reliable delivery and a seamless ordering experience, Feasto makes dining in as delightful as dining out.
        </p>
        <button
